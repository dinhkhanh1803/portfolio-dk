...
import ContentMockWorkbench from "./content-mock-workbench";
import FaviconPlaceholderWorkbench from "./favicon-placeholder-workbench";
import ConfigFileWorkbench from "./config-file-workbench";
import CronScheduleWorkbench from "./cron-schedule-workbench";
import MarkdownDocsWorkbench from "./markdown-docs-workbench";
import DeveloperUtilitiesWorkbench from "./developer-utilities-workbench";
import JsonToolsWorkbench from "./json-tools-workbench";
...
import VideoToolsWorkbench from "./video-tools-workbench";
...
const groups: ToolGroup[] = [
  ...
  { id: "generators", label: "Generators", collections: [
    ...
    { id: "mock-data", label: "Content & Mock Data Generators", icon: Database, tools: ["Lorem Ipsum", "Lorem Ipsum Generator", "Mock Data Generator", "Random Data Generator", "Number Sequence Generator"] },
    { id: "favicon-placeholder", label: "Favicon & Placeholder Generators", icon: ImageIcon, tools: ["Favicon Generator", "Emoji Favicon Generator", "Image Favicon Generator", "CSS Placeholder Generator", "Placeholder Image Generator", "Placeholder Image URL"] },
    { id: "config-files", label: "Config File Generators", icon: FileCode2, tools: ["CSP Generator", "Robots.txt Generator", ".gitignore Generator", "Nginx Config Generator", "chmod Calculator"] },
    { id: "cron-schedule", label: "Cron & Schedule Tools", icon: CalendarClock, tools: ["Cron Tools", "Crontab Visual Editor", "Crontab Explainer", "Cron Next-Run Preview"] },
    { id: "markdown-docs", label: "Markdown & Docs Generators", icon: FileText, tools: ["Markdown Tools", "Markdown Table Generator", "GitHub README Generator", "Markdown Badge Generator", "Commit Message Generator", "HTML Email Builder"] },
    { id: "developer-utilities", label: "Developer Utilities", icon: Code2, tools: ["SQL Playground", "QR Code Generator", "SVG Path Visualizer", "Keyboard Event Tester", "User Agent Parser", "Bitwise Calculator", "Credit Card Validator", "Semver Range Tester", "Code to Image"] },
  ]},
  { id: "formatters", label: "Formatters", collections: [
    { id: "json-tools", label: "JSON Tools", icon: Braces, tools: ["JSON Tools", "JSONPath Explorer", "JSON Minify & Pretty", "JSON to Table & CSV"] },
    { id: "code-formatters", label: "Code Formatters", icon: FileCode2, tools: ["Code Prettier", "SQL Formatter", "XML Formatter", "YAML Formatter", "TOML Formatter", ".env Formatter", "HTML Compressor / Minifier", "Column Formatter"] },
  ]},
